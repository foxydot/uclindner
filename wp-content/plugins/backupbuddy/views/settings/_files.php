...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery(document).on( 'click', '.pb_backupbuddy_filetree_exclude', function(){
			...
			if ( ( text == 'wp-config.php' ) || ( text == '/wp-content/' ) || ( text == '/wp-content/uploads/' ) || ( text == '<?php echo backupbuddy_core::getBackupDirectory(); ?>' ) || ( text == '/wp-content/uploads/backupbuddy_temp/' ) ) {
...
if ( $profile_array['type'] != 'defaults' ) {
	$settings_form->add_setting( array(
		...
		'after'		=>		' Use global defaults<br><span class="description">Uncheck to customize inclusions & exclusions.</span>',
		'css'		=>		'',
	) );
}
