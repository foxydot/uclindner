...
$settings_form->add_setting( array(
	...
	'tip'		=>		__('[Default: enabled] - When enabled, the importbuddy.php (restoration tool) file will be included within the backup archive ZIP file in the location `/wp-content/uploads/ backupbuddy_temp/xxxxxxxxxx/ importbuddy.php` where the x\'s match the unique random string in the backup ZIP filename.', 'it-l10n-backupbuddy' ),
	'css'		=>		'',
	'after'		=>		' <span style="white-space: nowrap;"><span class="description">' . __( 'Located in backup', 'it-l10n-backupbuddy' ) . ':</span>&nbsp; <span class="code pb_scroll" style="vertical-align: -15px; height: 30px; width: 150px; background: #EAEAEA;"">/wp-content/uploads/backupbuddy_temp/xxxxxxxxxx/importbuddy.php</span>',
	'rules'		=>		'required',
) );
...
$settings_form->add_setting( array(
	'type'		=>		'title',
	'name'		=>		'title_advanced',
	'title'		=>		__( 'Advanced Technical Operation', 'it-l10n-backupbuddy' ),
) );
