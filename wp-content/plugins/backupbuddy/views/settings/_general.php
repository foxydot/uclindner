...
$settings_form->add_setting( array(
	...
	'rules'		=>		'',
	'css'		=>		'width: 250px;',
	'after'		=>		' <span style="white-space: nowrap;"><span class="description">' . __( 'Blank for default', 'it-l10n-backupbuddy' ) . ':</span>&nbsp; <span class="code pb_scroll" style="vertical-align: -15px; height: 30px; width: 100px; background: #EAEAEA;"">' . backupbuddy_core::_getBackupDirectoryDefault() . '</span>',
